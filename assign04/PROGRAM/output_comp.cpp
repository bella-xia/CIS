...
int main(int argc, char **argv)
{
    ...
    else if (argc == 2 && strcmp(argv[1], "C") == 0)
    {
        ...
        std::string output_filename = "../OUTPUT/PA1 Student Answer/pa1-debug-output-stats-c-expected.txt";
    ...
    else
    {
        ...
        std::string output_filename = "../OUTPUT/PA1 Student Answer/pa1-debug-output-stats-pivots.txt";
        std::ofstream out_file(output_filename);
        if (out_file.is_open())
        {
