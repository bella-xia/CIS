...
int main(int argc, char **argv)
{
    ...
    // push vack the local frame points
    ...
    // push back the coordinates of points on first frame with respect to a global frame
    reg1.add_matrix_b(Matrix(0, 1, 0));
    reg1.add_matrix_b(Matrix(1, 0, 0));
    reg1.add_matrix_b(Matrix(0, -1, 0));
    reg1.add_matrix_b(Matrix(-1, 0, 0));
    // calculate its frame transformation
    ...
    // push back the coordinates of points on second frame with respect to a global frame
    ...
    // push back the coordinates of points on third frame with respect to a global frame
    ...
    // push back the coordinates of points on forth frame with respect to a global frame
    reg1.add_matrix_b(Matrix(-11, -10, 0));
    reg1.add_matrix_b(Matrix(-10, -9, 0));
    reg1.add_matrix_b(Matrix(-9, -10, 0));
    reg1.add_matrix_b(Matrix(-10, -11, 0));
    ...
    // use all four frames to conduct pivot calibration
