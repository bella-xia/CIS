...
int main(int argc, char **argv)
{
    ...
    // add them to the registration. Since both the local and global frame
    // are the same, expecting to see identity matrix
    ...
    // push back points after pivot rotation,
    // then perform pivot calibration
